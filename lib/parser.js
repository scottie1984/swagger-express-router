...
const validateProperty = (p_Property, p_PropertyName, p_Schema) => {
	...
	if (p_Schema) {
		if (typeof p_Property !== p_Schema.type) {
			errors.push({ code: errorCodes.REQUEST_ERROR_INVALID_TYPE, message: `property '${p_PropertyName}' should be of type '${p_Schema.type}' but was of type '${typeof p_Property}'` });
		} else {
